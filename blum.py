# Made with mr.mooe
# Join tele channel for update t.me/signalrektcrypto
import argparse
import random
import requests
...
while True:
    ...
    print(Fore.YELLOW + Style.BRIGHT + f"1. [ mr.mooe ] signalrektcrypto")
...
░▒▓█▓▒░░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓██▓▒░▒▓█▓▒░░▒▓█▓▒░░▒▓█▓▒░░▒▓██████▓▒░ ░▒▓██████▓▒░░▒▓████████▓▒░ 
    ...
    print(Fore.GREEN + Style.BRIGHT + "Update Link: https://github.com/mooe2708/blum")
    print(Fore.YELLOW + Style.BRIGHT + "Free Konsultasi Join Telegram Channel: https://t.me/signalrektcrypto")
    print(Fore.BLUE + Style.BRIGHT + "Buy me a coffee :) 089650675706 GOPAY / DANA")
